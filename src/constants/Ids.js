...
export const fundsSummaryIds = [
  "yzCH9OyAHf9",
  "ArM16lmaMz8;KJPVAwpIk0y",
] // earned+otg, expenditure

export const rbfFundId = 'UmmSfWTTVrX';

export const ipaUnits = [
  {id: 'all', name: "Total IPA Units", color:''},
  {id: 'lTWbUtgpXnY', name: "PHC", color: '#1C4E80'},
  {id: 'ebdy6X2sihf', name: "UPHC", color: '#1C4E80' },
  {id: 'hf5fntc0jnf', name: "CHC", color: '#AC3E31'},
  {id: 'LNDPC5ooJ1x', name: "District Hospitals", color:'#488A99'},
  {id: 'cP6Lbd6N5Vm', name: "District Health Teams", color: '#484848'},
  {id: 'M4nOL4QXt6p', name: "SHT and INS", color:'#DBAE58'},
];
